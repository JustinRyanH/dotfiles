...
lain.layout.centerwork.to_left = 0
...
-- {{{ Tags
tags = {
   names = { "web", "term", "docs", "media", "down", "dev"},
...
dofile(awful.util.getdir("config") .. "/" .. "layout.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey }, "m",
        function ()
            awful.util.spawn("amixer -D pulse sset Master playback toggle")
            volumewidget.update()
        end),
    awful.key({ altkey, "Control" }, "m",
        function ()
            awful.util.spawn("amixer -D pulse sset Master playback 100%")
            volumewidget.update()
        end),
    ...
    -- User programs
    awful.key({ modkey }, "r", function () awful.util.spawn(browser) end),
    awful.key({ modkey }, "i", function () awful.util.spawn(browser2) end),
    awful.key({ modkey }, "s", function () awful.util.spawn(gui_editor) end),
    awful.key({ modkey }, "p", function () awful.util.spawn('music-pause') end),
    awful.key({ modkey,  }, "v", function () awful.util.spawn(gui_editor2) end),
    awful.key({ modkey, altkey }, "s", function () awful.util.spawn(gui_editor3) end),
